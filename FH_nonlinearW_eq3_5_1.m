...
%initial surf ssh
eta=0.05*exp( -(X-xc).^2/8^2-(Y-xc).^2/8^2);
H=eta+h;
        ...
        for kk=1:Ny-1
            if kk>1
                u1(jj,kk)=(1+lambd(jj,kk)+nuu(jj,kk))*us(jj,kk)......
                    -lambd(jj,kk)*(us(jj+1,kk)-u1(jj-1,kk))......
                    -nuu(jj,kk)*us(jj,kk+1) + nud(jj,kk)*u1(jj,kk-1);
            else
                u1(jj,kk)=(1+lambd(jj,kk)+nuu(jj,kk))*us(jj,kk)......
                    -lambd(jj,kk)*(us(jj+1,kk)-u1(jj-1,kk))......
                    -nuu(jj,kk)*us(jj,kk+1) +       0; %this boundary condition could be improved!
            end
        ...
        for jj=1:Nx-1
            if jj>1
                v1(jj,kk)=(1+lambdr(jj,kk)+nu(jj,kk))*vs(jj,kk)......
                    -nu(jj,kk)*(vs(jj,kk+1)-v1(jj,kk-1))......
                    -lambdr(jj,kk)*vs(jj+1,kk) + lambdl(jj,kk)*v1(jj-1,kk);
            else
                v1(jj,kk)=(1+lambdr(jj,kk)+nu(jj,kk))*vs(jj,kk)......
                    -nu(jj,kk)*(vs(jj,kk+1)-v1(jj,kk-1))......
                    -lambdr(jj,kk)*vs(jj+1,kk) + 0;
            end
        ...
        for kk=Ny-1:-1:1
            if kk>1
                u(jj,kk)=(1+lambd(jj,kk)+nud(jj,kk))*us(jj,kk)......
                    -lambd(jj,kk)*(u(jj+1,kk)-us(jj-1,kk))......
                    -nuu(jj,kk)*u(jj,kk+1) + nud(jj,kk)*us(jj,kk-1) ;
            else
                u(jj,kk)=(1+lambd(jj,kk)+nud(jj,kk))*us(jj,kk)......
                    -lambd(jj,kk)*(u(jj+1,kk)-us(jj-1,kk))......
                    -nuu(jj,kk)*u(jj,kk+1) +0 ;
            end
        ...
        for jj=Nx-1:-1:1
            if jj>1
                v(jj,kk)=(1+lambdl(jj,kk)+nu(jj,kk))*vs(jj,kk)......
                    -nu(jj,kk)*(v(jj,kk+1)-vs(jj,kk-1))......
                    -lambdr(jj,kk)*v(jj+1,kk) + lambdl(jj,kk)*vs(jj-1,kk);
            else
                v(jj,kk)=(1+lambdl(jj,kk)+nu(jj,kk))*vs(jj,kk)......
                    -nu(jj,kk)*(v(jj,kk+1)-vs(jj,kk-1))......
                    -lambdr(jj,kk)*v(jj+1,kk) + 0;
            end
...
%                 imagesc((1:Nx)*dx*1.e-3,(1:Nx)*dx*1.e-3,eta');
        ...
        if niter == 0
            imwrite(imind,cm,'assignment2_6_nonlinear-HN-eq3-5-1.gif','gif', 'Loopcount',inf);
        else
            imwrite(imind,cm,'assignment2_6_nonlinear-HN-eq3-5-1.gif','gif','WriteMode','append');
        end
